...
<a href="https://join.slack.com/t/rl4co/shared_invite/zt-1ytz2c1v4-0IkQ8NQH4TRXIX8PrRmDhQ"><img src="https://img.shields.io/badge/slack-chat-611f69.svg?logo=slack" alt="Slack"></a>
...
<a href="https://pypi.org/project/rl4co"><img src="https://img.shields.io/pypi/v/rl4co?logo=pypi" alt="PyPI"></a>
<a href="https://app.codecov.io/github/ai4co/rl4co/tree/main/rl4co"><img src="https://codecov.io/github/ai4co/rl4co/tree/main/badge.svg" alt="Codecov"></a>
<a href="https://github.com/ai4co/rl4co/actions/workflows/tests.yml"><img src="https://github.com/ai4co/rl4co/actions/workflows/tests.yml/badge.svg" alt="Test"></a>

<a href="https://rl4co.readthedocs.io/" target="_blank"><strong>Documentation</strong></a> | 
<a href="#getting-started"><strong>Getting Started</strong></a> | 
<a href="#usage"><strong>Usage</strong></a> | 
<a href="#contributing"><strong>Contributing</strong></a> | 
<a href="https://arxiv.org/abs/2306.17100" target="_blank"><strong>Paper</strong></a> | 
...
??? note "Disable logging or callbacks"
    Disable logging or callbacks by using Hydra's `~` operator:
    ```bash
    python run.py experiment=routing/am logger=none '~callbacks.learning_rate_monitor'
    ```

??? note "Create a sweep over hyperparameters"
