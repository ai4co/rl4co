...
- [`4-positional-encodings.ipynb`](4-positional-encodings.ipynb): here we show how to use and visualize the positional encodings in `rl4co.utils.pe`, organized around the distance / circularity / hierarchy desiderata for routing PEs.