...
if __name__ == "__main__":
    ...
    argparser.add_argument("--checkpoint", type=str, default="epoch_099.ckpt")
    ...
    argparser.add_argument("--start_batch_size", type=int, default=16_384, help="Batch size for scaling evaluation")
