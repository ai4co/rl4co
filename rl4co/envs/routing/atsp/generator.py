    ...
    def __init__(
        ...
        **kwargs
        ...
        if kwargs.get("dist_sampler", None) is not None:
            ...
            self.dist_sampler = get_sampler("dist", dist_distribution, min_dist, max_dist, **kwargs)

    def _generate(self, batch_size) -> TensorDict:
        # Sample distance matrices
        dms = self.dist_sampler.sample((*batch_size, self.num_loc, self.num_loc))
        
        # Distance to node itself is 0
